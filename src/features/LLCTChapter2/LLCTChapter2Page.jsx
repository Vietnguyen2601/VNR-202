...
import { aiTools, antiFrench, logic, modern, notes, outcomes, periods, references, timeline } from './data/content'
import { AudiencePrompt, PeriodCard, ProgressBar, SectionTitle, SpeakerNotes, StickyNav } from './components/PresentationComponents'
...
export default function LLCTChapter2Page() {
  ...
  return <main className="llct-page">
    ...
    <section id="france" className="llct-section dark-panel">
      <SectionTitle index="02" eyebrow="Kháng chiến chống Pháp · LO2 + LO3" title="Thắng lợi để lại điều gì?" subtitle="Không chỉ một kết quả quân sự, mà còn là nền tảng chính trị và hệ kinh nghiệm lãnh đạo cho chặng đường tiếp theo." />
    ...
    <section id="1954-1960" className="llct-section split-era">
      <SectionTitle index="03" eyebrow="1954–1960 · LO2 + LO3" title="Khác nhiệm vụ. Chung phương hướng." subtitle="Hai miền vận động theo điều kiện riêng nhưng tương tác trong một chiến lược cách mạng thống nhất." />
    ...
    <section id="congress" className="llct-section congress-section">
      <SectionTitle index="04" eyebrow="Đại hội III · 9/1960" title="Một đất nước · Hai chiến lược · Một mục tiêu" />
    ...
    <section id="1961-1965" className="llct-section split-era latter-era">
      <SectionTitle index="05" eyebrow="1961–1965 · LO2 + LO3" title="Hậu phương tạo lực. Tiền tuyến tạo thế." />
    ...
    <section id="logic" className="llct-section logic-section">
      <SectionTitle index="06" eyebrow="Phân tích · Không chỉ kể sự kiện" title="Từ sự kiện đến tư duy lãnh đạo" subtitle="Mở từng câu hỏi để đi qua chuỗi: hoàn cảnh → quyết định → ý nghĩa." />
    ...
    <section id="lo" className="llct-section lo-section">
      <SectionTitle index="07" eyebrow="Learning Outcomes" title="Học để nhận diện, phân tích và vận dụng" />
    ...
    <section id="modern" className="llct-section modern-section">
      <SectionTitle index="08" eyebrow="Liên hệ hiện nay · LO4" title="Lịch sử không ở lại phía sau" subtitle="Giá trị của bài học nằm ở nguyên tắc tư duy, không phải sao chép máy móc giải pháp của quá khứ." />
    ...
    <section id="ai" className="llct-section ai-section">
      <SectionTitle index="09" eyebrow="AI Usage & Academic Integrity" title="AI hỗ trợ. Sinh viên chịu trách nhiệm." />
    ...
    <section id="references" className="llct-section references-section">
      <SectionTitle index="10" eyebrow="Nguồn & đối chiếu" title="Đặt độ tin cậy lên trước tốc độ" />
