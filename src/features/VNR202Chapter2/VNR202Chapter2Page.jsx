...
export default function VNR202Chapter2Page() {
  useEffect(() => {
    document.title = 'VNR-202 Chapter 2 Presentation'
    ...
    return () => { observer.disconnect(); document.body.classList.remove('vnr202-body') }
  }, [])

  return <main className="vnr202-page">
    <ProgressBar /><StickyNav /><ChatBox />
    <section id="hero" className="vnr202-hero">
    ...
    <section id="context" className="vnr202-section timeline-section">
    ...
    <section id="key-events" className="vnr202-section key-events-section">
    ...
    <section id="evidence" className="vnr202-section evidence-section">
    ...
    <section id="france" className="vnr202-section dark-panel">
    ...
    <section id="1954-1960" className="vnr202-section split-era">
    ...
    <section id="congress" className="vnr202-section congress-section">
    ...
    <section id="1961-1965" className="vnr202-section split-era latter-era">
    ...
    <section id="logic" className="vnr202-section logic-section">
    ...
    <section id="lo" className="vnr202-section lo-section">
    ...
    <section id="review-game" className="vnr202-section review-game-section">
    ...
    <section id="modern" className="vnr202-section modern-section">
    ...
    <section id="ai" className="vnr202-section ai-section">
    ...
    <section id="references" className="vnr202-section references-section">
    ...
    <section id="conclusion" className="vnr202-conclusion">
